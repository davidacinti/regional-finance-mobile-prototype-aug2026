...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/css/regionals-theme.css') }}?v=20260908-mobile-viewport">
</head>

<body class="{{ !empty($prototypeMobileApp) ? 'prototype-app-body' : '' }}">
