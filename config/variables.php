...
// Variables
return [
  "creatorName" => "Regionals",
  "creatorUrl" => "#",
  "templateName" => "Regionals",
  "templateSuffix" => "Prototype Starter Kit",
  "templateVersion" => "2.0.0",
  "templateFree" => false,
  "templateDescription" => "Reusable branded prototyping starter kit for Regionals.",
  "templateKeyword" => "regionals, prototype, starter kit, vuexy, laravel",
